...
public final class OpGetFishRarityJ implements ConstMediaAction {

    public static final OpGetFishRarityJ INSTANCE = new OpGetFishRarityJ();

    private OpGetFishRarityJ() {}
